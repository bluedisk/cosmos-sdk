...
func TestSameDenomAsCoin(t *testing.T) {
	cases := []struct {
		...
		{NewInt64Coin("luna", 1), NewInt64Coin("luna", 10), true},
		{NewInt64Coin("luna", -11), NewInt64Coin("luna", 10), true},
	}
...
func TestIsEqualCoin(t *testing.T) {
	cases := []struct {
		...
		{NewInt64Coin("A", 1), NewInt64Coin("a", 1), false},
		{NewInt64Coin("a", 1), NewInt64Coin("b", 1), false},
		{NewInt64Coin("luna", 1), NewInt64Coin("luna", 10), false},
		{NewInt64Coin("luna", -11), NewInt64Coin("luna", 10), false},
	}
