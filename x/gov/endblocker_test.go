...
func TestTickExpiredDepositPeriod(t *testing.T) {
	...
	newProposalMsg := NewMsgSubmitProposal("Test", "test", ProposalTypeText, addrs[0], sdk.Coins{sdk.NewInt64Coin("luna", 5)})
...
func TestTickMultipleExpiredDepositPeriod(t *testing.T) {
	...
	newProposalMsg2 := NewMsgSubmitProposal("Test2", "test2", ProposalTypeText, addrs[1], sdk.Coins{sdk.NewInt64Coin("luna", 5)})
...
func TestTickPassedDepositPeriod(t *testing.T) {
	...
	newDepositMsg := NewMsgDeposit(addrs[1], proposalID, sdk.Coins{sdk.NewInt64Coin("luna", 5)})
