...
var (
	coinsPos         = sdk.Coins{sdk.NewInt64Coin("luna", 1000)}
	coinsZero        = sdk.Coins{}
	coinsNeg         = sdk.Coins{sdk.NewInt64Coin("luna", -10000)}
	coinsPosNotAtoms = sdk.Coins{sdk.NewInt64Coin("foo", 10000)}
	coinsMulti       = sdk.Coins{sdk.NewInt64Coin("foo", 10000), sdk.NewInt64Coin("luna", 1000)}
)
