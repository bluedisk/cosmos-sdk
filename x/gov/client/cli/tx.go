...
$ terracli gov submit-proposal --proposal="path/to/proposal.json"
...
$ terracli gov submit-proposal --title="Test Proposal" --description="My awesome proposal" --type="Text" --deposit="1000test"
`),
