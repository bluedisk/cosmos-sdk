...
func createValidators(t *testing.T, stakeHandler sdk.Handler, ctx sdk.Context, addrs []sdk.ValAddress, coinAmt []int64) {
	...
	for i := 0; i < len(addrs); i++ {
		valCreateMsg := stake.NewMsgCreateValidator(
			addrs[i], pubkeys[i], sdk.NewInt64Coin("luna", coinAmt[i]), testDescription, testCommissionMsg,
		)
...
func TestTallyDelgatorOverride(t *testing.T) {
	...
	delegator1Msg := stake.NewMsgDelegate(addrs[3], sdk.ValAddress(addrs[2]), sdk.NewInt64Coin("luna", 30))
...
func TestTallyDelgatorMultipleOverride(t *testing.T) {
	...
	delegator1Msg := stake.NewMsgDelegate(addrs[3], sdk.ValAddress(addrs[2]), sdk.NewInt64Coin("luna", 10))
	stakeHandler(ctx, delegator1Msg)
	delegator1Msg2 := stake.NewMsgDelegate(addrs[3], sdk.ValAddress(addrs[1]), sdk.NewInt64Coin("luna", 10))
...
func TestTallyDelgatorMultipleInherit(t *testing.T) {
	...
	val1CreateMsg := stake.NewMsgCreateValidator(
		sdk.ValAddress(addrs[0]), ed25519.GenPrivKey().PubKey(), sdk.NewInt64Coin("luna", 25), testDescription, testCommissionMsg,
	)
	stakeHandler(ctx, val1CreateMsg)

	val2CreateMsg := stake.NewMsgCreateValidator(
		sdk.ValAddress(addrs[1]), ed25519.GenPrivKey().PubKey(), sdk.NewInt64Coin("luna", 6), testDescription, testCommissionMsg,
	)
	stakeHandler(ctx, val2CreateMsg)

	val3CreateMsg := stake.NewMsgCreateValidator(
		sdk.ValAddress(addrs[2]), ed25519.GenPrivKey().PubKey(), sdk.NewInt64Coin("luna", 7), testDescription, testCommissionMsg,
	)
